...
embedding_source = {'random': 'random',
                    'glove': 'glove.840B.300d',
                    'word2vec': 'GoogleNews-vectors-negative300',
                    'fasttext': 'crawl-300d-2M',
                    'numberbatch': 'numberbatch-en',
                    'deps': 'deps'}
experiment_type = 'embeddings'  # TODO !Change experiment_type name?!
for embedding_type in ['random', 'glove', 'word2vec', 'fasttext', 'numberbatch', 'deps']:
    for embedding_dim in [50, 100, 150, 200, 250, 300]:
        for curr_model_name in ['cnn', 'text_cnn', 'dcnn', 'rcnn', 'lstm', 'bi_lstm', 'gru', 'bi_gru']:
            for i in range(1, 11):
                ...
                experiment_params = {'task_name': 'swda',
                                     ...
                                     'embedding_source': embedding_source[embedding_type]}
